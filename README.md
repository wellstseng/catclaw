...
以 Discord 為介面的 AI Agent 運行平台 — multi-turn agent loop、21 builtin tools、27 builtin skills、多 provider failover、四層記憶引擎、Web Dashboard。
...
| **Skills** | 27 builtin skills（24 TypeScript + 3 prompt 型）— config、session、account、status、restart、plan、remind 等 |
