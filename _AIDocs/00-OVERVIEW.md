...
- **21 builtin tools**：file read/write/edit、run_command、search、memory、subagent 等
- **27 builtin skills**：Discord 指令層（/think、/mode、/use、/stop、/plan、/remind 等）
