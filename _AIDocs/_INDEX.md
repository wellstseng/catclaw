...
27 builtin skills（24 TS + 3 prompt）、多 provider failover、四層記憶引擎、Context Engineering、subagent 編排、
...
| Skills | `src/skills/` | Skill registry + 27 builtin skills（24 TS + 3 prompt） |
